  ...
  return (
    <div className='my-9'>
      ...
      <main className="py-12 md:px-20 sm:px-14 px-6">
        <div className="sm:flex mb-14 px-5 py-4 items-center shadow-md">
        ...
        <div className="mt-6 md:flex  space-x-6">
          <div className='shadow-md p-4'>
            <img src="https://images.unsplash.com/photo-1527689368864-3a821dbccc34?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" />
            <div>
